# -*- coding: utf-8 -*-
#
# SysAdm Client Handbook documentation build configuration file, created by
...
#
# html_title = u'SysAdm Client Handbook v1.0'
...
htmlhelp_basename = 'SysAdmClientHandbookdoc'
...
man_pages = [
    (master_doc, 'sysadmclienthandbook', u'SysAdm Client Handbook Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SysAdmClientHandbook', u'SysAdm Client Handbook Documentation',
     author, 'SysAdmClientHandbook', 'One line description of project.',
     'Miscellaneous'),
]
